...
fn run_setup_refresh_inner(
    ...
    run_setup_singleflight(b64.clone(), || run_setup_refresh_payload(&b64, request.codex_home))
}
...
pub struct SetupMarker {
    ...
    #[serde(default, skip_serializing_if = "WindowsSandboxPolicyNamespace::is_codex")]
...
pub(crate) fn run_setup_network_verification_exe_at_with_policy_lease(
    ...
    let mut stderr = child
        .stderr
        .take()
        .ok_or_else(|| failure(SetupErrorCode::OrchestratorHelperLaunchFailed, "firewall verification helper stderr was unavailable"))?;
...
mod tests {
    ...
    fn setup_marker_request_mismatch_reason_ignores_proxy_drift_for_online_identity() {
        let marker = super::SetupMarker {
            ...
            policy_namespace:
                crate::policy_namespace::WindowsSandboxPolicyNamespace::Codex,
            created_at: None,
    ...
    fn persisted_identity_state_must_match_the_exact_policy_namespace() {
        ...
        assert!(
            !marker
                .identities_match(crate::policy_namespace::WindowsSandboxPolicyNamespace::McpConsole)
        );
        assert!(
            !users
                .identities_match(crate::policy_namespace::WindowsSandboxPolicyNamespace::McpConsole)
