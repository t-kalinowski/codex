...
| `codex-rs/windows-sandbox-rs/src/standalone/client.rs`                 | New exact-helper launch client, suspended helper process and initial-thread sealing, trusted runner-SID handoff, direct-handle duplication, two-phase ready/commit handshake, observation, fail-safe helper retirement, and standalone policy lease ownership.                                                                                                                                                             |
