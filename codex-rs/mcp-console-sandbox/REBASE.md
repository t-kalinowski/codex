...
| `codex-rs/windows-sandbox-rs/src/standalone/helper.rs`                 | New capability-restricted target helper with suspended pre-commit creation, a gated and sealed control thread, non-breakaway Job ownership, limited rights against infrastructure processes, and separate root/final outcomes.                                                                                                                                                                                                                   |
