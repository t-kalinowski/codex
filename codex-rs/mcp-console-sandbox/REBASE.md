...
| `tools/argument-comment-lint/list-bazel-targets.sh`                    | Exclude only the runner's config-required contract test from ordinary unstamped argument-comment discovery while retaining the runner library, executable, and fixture targets in the repository-wide lint.                                                                                                                                                                               |
