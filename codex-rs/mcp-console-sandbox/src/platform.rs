...
pub(crate) struct PreparedCommand {
    ...
    #[cfg(target_os = "linux")]
    pub(crate) bwrap_info: crate::linux_process::BwrapInfoReader,
    #[cfg(target_os = "linux")]
    pub(crate) bwrap_info_writer: crate::linux_process::BwrapInfoWriter,
    ...
    pub(crate) launch_commit_status: crate::launch_bridge::LaunchCommitStatus,
    pub(crate) launch_commit_status_writer: std::os::fd::OwnedFd,
}

#[cfg(target_os = "linux")]
struct LinuxLaunchContext<'a> {
    state_directory: &'a Path,
    bwrap_info_fd: std::os::fd::RawFd,
}
...
mod unix {
    ...
    pub(super) fn prepare_command(
        ...
        #[cfg(target_os = "linux")]
        let (bwrap_info, bwrap_info_writer) = crate::linux_process::bwrap_info_channel()
            .context("create packaged bubblewrap process-information channel")?;
        ...
        let mut command = native_command(
            ...
            LinuxLaunchContext {
                state_directory,
                bwrap_info_fd: bwrap_info_writer.as_raw_fd(),
            },
            #[cfg(not(target_os = "linux"))]
            state_directory,
        )?;
    ...
    fn native_command(
        ...
        let embedding =
            codex_linux_sandbox::prepare_packaged_bwrap(&runner, context.state_directory)
                .map_err(anyhow::Error::msg)
        ...
        let target = std::iter::once(program.to_os_string())
            ...
            .collect();
        let mut helper_arguments = embedding.helper_args_with_info_fd(context.bwrap_info_fd);
