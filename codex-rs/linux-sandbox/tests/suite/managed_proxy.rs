...
const BWRAP_COMPATIBILITY_QUERY: &str =
    "--codex-mcp-console-sandbox-bwrap-compatibility-v2";
...
fn dispatch_query_refusing_bwrap_fixture() {
    ...
    let target = std::env::var_os(BWRAP_FIXTURE_TARGET_ENV)
        .expect("query-refusing bwrap fixture target");
